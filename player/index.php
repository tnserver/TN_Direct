...
<hr/>
  ...
  <div class="resp-container"> <iframe class="resp-iframe" src="https://sharer.pw/player/<?=$_GET['id']?>" gesture="media" allow="encrypted-media" allowfullscreen="" mozallowfullscreen="true" webkitallowfullscreen="true" sandboxscrolling="no" sandbox="allow-scripts allow-same-origin"></iframe> </div>
